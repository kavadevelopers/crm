...
.add_container .checkmark:after {
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
	        ...
	        <li class=""><a href="user_wise.php?id=<?php echo $follow->assign_for; ?>&type=<?php echo $_GET['type']; ?>"><i class="fa fa-comment"></i>Followups</a></li>
			...
			<div class="col-md-12">
	          <div class="box box-solid">
	            <div class="box-header with-border" style="border-bottom: solid 2px #e6e7e8;">
	              ...
	              <a href="edit_lead_user_wise.php?id=<?php echo $_GET['id']; ?>&user=<?php echo $follow->assign_for; ?>&type=<?php echo $_GET['type']; ?>" class="btn btn-success btn-sm pull-right">Edit</a>
		        ...
		        <div class="row" >
		        	<div class="col-md-12">
		        		...
		        		<div class="col-md-6" >
		        		<form action="process/add_note.php" method="post" id="submit" enctype="multipart/form-data">
							...
							<div class="col-md-12">
								...
								<input type="hidden" name="ass_for" value="<?php echo $follow->assign_for; ?>">
								<input type="hidden" name="type_lead" value="<?php echo $_GET['type']; ?>">
							</div>
		        		...
		        		<div class="box-body">
		        			<div class="col-md-12">
								...
								<a href="user_wise.php?id=<?php echo $follow->assign_for; ?>&type=<?php echo $_GET['type']; ?>" onclick="window.close();"  class="btn btn-default">Cancel</a>
							</div>
						</div>
