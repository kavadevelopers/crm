...
.add_container .checkmark:after {
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
	        ...
	        <li class=""><a href="manage_lead.php"><i class="fa fa-list"></i> Manage Lead</a></li>
	        <li class="active"><i class="fa fa-comment"></i>Lead View</li>
      	</ol>
    </section>
    <style type="text/css">
    	dt
	          ...
	          <div class="box box-solid">
		        ...
		        <div class="row" >
		        	<div class="col-md-12">
		        		<div class="col-md-6" >
		        			<div class="box-body" >
		        				<div class="box-header with-border" style="border-top: solid 2px #e6e7e8; border-bottom: solid 2px #e6e7e8;">
					              <h3 class="box-title">Note's<?= $note->num_rows; ?></h3>
					            </div>
		        		...
		        		<div class="col-md-6" >
		        		<form action="process/add_note_all_lead.php" method="post" id="submit" enctype="multipart/form-data">
