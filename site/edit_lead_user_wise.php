...
<div class="content-wrapper">
    ...
    <section class="content-header">
		...
		<ol class="breadcrumb">
	        ...
	        <li class="active"><a href="add_follow_user_wise.php?id=<?php echo $_GET['id']; ?>&type=<?php echo $_GET['type']; ?>"><i class="fa fa-comment"></i> Add FollowUp</a></li>
...
?>
<form action="process/edit_lead_user_wise.php" method="post" id="submit" enctype="multipart/form-data">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="box-footer">
							...
							<a href="add_follow_user_wise.php?id=<?php echo $_GET['id']; ?>&type=<?php echo $_GET['type']; ?>" class="btn btn-default">Cancel</a>
						</div>
					</div>
				</div>
			</div>
