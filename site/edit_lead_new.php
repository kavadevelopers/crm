...
<div class="content-wrapper">
    ...
    <section class="content-header">
		...
		<ol class="breadcrumb">
	        ...
	        <li class=""><a href="add_follow.php?id=<?php echo $_GET['id']; ?>&type=<?php echo $_GET['type']; ?>"><i class="fa fa-comment"></i> Add FollowUp</a></li>
...
?>
<form action="process/edit_lead_new.php" method="post" id="submit" enctype="multipart/form-data">
    <section class="content">
		...
		<input type="hidden" name="TYpe_hid" value="<?php echo $_GET['type']; ?>">
        <div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="box-footer">
							...
							<a href="add_follow.php?id=<?php echo $_GET['id']; ?>&type=<?php echo $_GET['type']; ?>" class="btn btn-default">Cancel</a>
						</div>
					</div>
				</div>
			</div>
